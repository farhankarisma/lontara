                ...
                <SettingSection title="Profil Pengguna" icon={User}>
                  <div className="space-y-6">
                    <ProfilePictureUpload
                      ...
                      onUpload={(avatar) =>
                        updateSetting("profile", "avatar", avatar)
                      }
                    />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateSetting("profile", "position", e.target.value)
                          }
                          className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
                          disabled
                        />
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      <ToggleSwitch
                        ...
                        onChange={(value) =>
                          updateSetting("security", "ipWhitelist", value)
                        }
                      />
                    </SettingItem>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <ToggleSwitch
                          ...
                          onChange={(value) =>
                            updateSetting("system", "autoBackup", value)
                          }
                        />
                      </SettingItem>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Berapa lama file akan disimpan sebelum dihapus
                          otomatis
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {[
                            ...
                            >
                              <input
                                type="checkbox"
                                checked={settings.system.allowedFileTypes.includes(
                                  type
                                )}
                                onChange={(e) => {
                                  const types = e.target.checked
                                    ? [
                                        ...settings.system.allowedFileTypes,
                                        type,
                                      ]
                                    : settings.system.allowedFileTypes.filter(
                                        (t) => t !== type
                                      );
                                  updateSetting(
                                    "system",
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <ToggleSwitch
                          ...
                          onChange={(value) =>
                            updateSetting("system", "enableLogging", value)
                          }
                        />
                      </SettingItem>
